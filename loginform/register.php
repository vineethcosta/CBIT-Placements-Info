...
if (isset($_POST['signup'])) {
    ...
    if ($count == 0) { // if email is not found add user
        ...
        $stmts = $conn->prepare("INSERT INTO users(username,email,password,branch,attendance,cgpa,rno) VALUES(?, ?, ? ,? ,? ,? ,?)");
        $stmts->bind_param("ssssddd", $uname, $email, $password, $ubranch ,$uatt, $ucgpa, $urno);
        ...
        <form method="post" autocomplete="off">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                        <input type="text" name="att" class="form-control" placeholder="Enter Attendance"
                               required/>
                    </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                        <input type="text" name="rno" class="form-control" placeholder="Enter your rno"
                               required/>
                    </div>
                </div>
                <div class="checkbox">
